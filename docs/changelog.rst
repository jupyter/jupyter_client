...
-  Support answer_yes when removing kernel specs (:ghpull:`659`)
...
-  PR: Don’t block on exit (:ghpull:`651`)
...
-  [Release 7.0] Remove deprecations in kernel manager (:ghpull:`643`)
...
-  Added missing documentation for the inspectVariables request and resp… (:ghpull:`649`)
